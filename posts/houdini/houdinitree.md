...
![2.png](assets/houdinitree/001-fa7abf7c.png)
...
![3.png](assets/houdinitree/002-dbc95fe4.png)
...
![4.png](assets/houdinitree/003-f3c2c039.png)
...
![5.png](assets/houdinitree/004-1766551d.png)


在撒点范围内撒树枝生成点，


![6.png](assets/houdinitree/005-dca75814.png)


制作树枝：


![7.png](assets/houdinitree/006-f09590d1.png)
...
![8.gif](assets/houdinitree/007-5ae52612.gif)
...
![9.png](assets/houdinitree/008-6c6cda2a.png)


法线传递：


![10.png](assets/houdinitree/009-828c9415.png)


先使用凸包构建一个mesh之后将mesh转换为VDB体素(平滑mesh)再将体素转换为mesh，连接remesh细分网格之后在smooth平滑一下，最后计算包围盒法线。使用包围盒法线转导到树mesh点上。


![11.png](assets/houdinitree/010-0f586c78.png)


![12.png](assets/houdinitree/011-04b30adb.png)


![13..png](assets/houdinitree/012-0cdf7e14.png)
...
![14.gif](assets/houdinitree/013-4985db00.gif)
...
![15.png](assets/houdinitree/014-06a465f7.png)
...
![16.png](assets/houdinitree/015-370a97fd.png)


![17.png](assets/houdinitree/016-b8015b0a.png)
...
![18.png](assets/houdinitree/017-3e2bb87e.png)


![19.png](assets/houdinitree/018-56c97c76.png)
...
![20.png](assets/houdinitree/019-30ac9cf6.png)


到目前为止所描述的系统生成平面几何。要在3D中移动L-System，您可以使用&(向上俯仰)、^(向下俯仰)、\\(顺时针滚动)和/(逆时针滚动)命令。例如，初始 Premise FFFA和Rule A=“[&FFFA] //// [&FFFA] /// [&FFFA] [&FFFA]”。


![21.png](assets/houdinitree/020-01df898a.png)


不同迭代次数的结果使用   


![22.png](assets/houdinitree/021-8c0773d5.png)


![23.png](assets/houdinitree/022-c57266ec.png)
...
![24.png](assets/houdinitree/023-d54be5e2.png)
...
![25.png](assets/houdinitree/024-15f7a89d.png)
...
![26.png](assets/houdinitree/025-3351ca56.png)
