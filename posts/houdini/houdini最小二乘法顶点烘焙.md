...
source: "notion-sync"
---
[https://users.cs.utah.edu/~ladislav/kavan11least/kavan11least.pdf](https://users.cs.utah.edu/~ladislav/kavan11least/kavan11least.pdf)


[https://www.twblogs.net/a/5ef0c2afc3cd5d0a4793eb37](https://www.twblogs.net/a/5ef0c2afc3cd5d0a4793eb37)   可能需要科学上网
...
![Untitled.png](assets/houdini最小二乘法顶点烘焙/001-2f83811f.png)
...
![Untitled.jpeg](assets/houdini最小二乘法顶点烘焙/002-9458dc63.jpeg)


![Untitled.jpeg](assets/houdini最小二乘法顶点烘焙/003-bfa7e62f.jpeg)
...
![QianJianTec1704635736839.png](assets/houdini最小二乘法顶点烘焙/004-e9348203.png)
...
![QianJianTec1704183240465.png](assets/houdini最小二乘法顶点烘焙/005-58331b41.png)


梯度下降的核心便是这个公式。$eta$是所谓的学习率，也就是步进值，决定我们每次步进多少。是一个经验值。    $\bigtriangledown f(x)$是函数$f(x)$梯度。


![Untitled.png](assets/houdini最小二乘法顶点烘焙/006-08842bab.png)


现在我们只需要求得函数梯度，推导可得以下公式： （推导过程链接有）


![QianJianTec1704645620734.png](assets/houdini最小二乘法顶点烘焙/007-9df8d89d.png)
