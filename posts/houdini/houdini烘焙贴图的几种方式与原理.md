...
![Untitled.png](assets/houdini烘焙贴图的几种方式与原理/001-d9013c52.png)
...
![Untitled.png](assets/houdini烘焙贴图的几种方式与原理/002-18dc43de.png)
...
![Untitled.png](assets/houdini烘焙贴图的几种方式与原理/003-3ec02d1f.png)
...
![Untitled.png](assets/houdini烘焙贴图的几种方式与原理/004-c8d64e68.png)


将uv合并起来为一个vector通过xyzdist找到OUT_UV上最近的一个点UV值，通过这个UV值去找OUT_GEO上对应位置UV的属性，我们就可以拿到我们需要的属性啦。然后output即可。


![Untitled.png](assets/houdini烘焙贴图的几种方式与原理/005-353bbe88.png)
...
![Untitled.png](assets/houdini烘焙贴图的几种方式与原理/006-3eeecf9d.png)
...
![Untitled.png](assets/houdini烘焙贴图的几种方式与原理/007-3325030c.png)


然后我们转到Shop层级新建一个材质 material shader builder(也可以在mat层级建一个 随意啦)。我们就简单输出一个法线N吧，里面还可以自己Bind 需要的属性输出。


![Untitled.png](assets/houdini烘焙贴图的几种方式与原理/008-cc860a18.png)


![Untitled.png](assets/houdini烘焙贴图的几种方式与原理/009-0f3369d2.png)


有了材质之后，我们给我们的geo的Render上 上我们的材质。


![Untitled.png](assets/houdini烘焙贴图的几种方式与原理/010-92b49b25.png)


再转到out层级，新建一个baketexture节点，讲我们要烘焙的物体路径给上 UV Objector(我们也可以高模烘焙到低模，将对应模型拖到对应栏即可)，调整好输出路径。


![Untitled.png](assets/houdini烘焙贴图的几种方式与原理/011-e5e79a24.png)


接下来就是我们要输出什么信息，渲染那些通道。这里我只要法线N就好啦，下面那个是我们可以渲染额外的通道。


![Untitled.png](assets/houdini烘焙贴图的几种方式与原理/012-c37de0f1.png)


然后直接点击 Render to Disk就好啦，渲染前我们还可以 点击 Render to MPlay 预览一下结果，记得要选择一下你要预览的通道。


![Untitled.png](assets/houdini烘焙贴图的几种方式与原理/013-d7d9ac7b.png)
