...
> 通过官方网站能搜索到一篇文章讲述了如果远程调试Houdini的文章( DEBUGGING PYTHON IN VFX APPLICATIONS )，这里面用的库 ptvsd 已经过时，VSCode 已经转为使用 debugpy 这 个库了。
...
![Untitled.png](assets/vscode调试houdinipython/001-9c84d676.png)


配置文件内容如下:


![Untitled.png](assets/vscode调试houdinipython/002-024c2d62.png)
...
![Untitled.png](assets/vscode调试houdinipython/003-185b7abe.png)
