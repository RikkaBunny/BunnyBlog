---
title: "Houdini中岩石任意形变矩阵到UE还原"
categories: ["UE"]
date: "2024-01-17"
created: "2024-01-17T04:19:00.000Z"
updated: "2024-01-17T04:32:00.000Z"
notion_url: "https://www.notion.so/Houdini-UE-74207fdb5fbd46be828fdf3bd20a8bb3"
...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/001-d65efde3.png)


当模型的变换符合矩阵变换的规则，[https://chartreuse-room-39e.notion.site/e47e1c2cf20b43c0b1ff38fa42a0db35](/e47e1c2cf20b43c0b1ff38fa42a0db35)那么模型的拟合误差则为0，为完全重合。通过extracttransform节点我们就可以得到两模型的变换矩阵。


![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/002-9d857c54.png)


当我们在houdini得到一个任意的形变矩阵，我们都可以将其在拆分为最简单的几个矩阵的乘积， 分别为 位移矩阵、旋转矩阵、缩放矩阵、剪切矩阵。通过矩阵之间合理的拆分与组合，我们可以在任何地方(DCC 或者 引擎中)进行形变的拆解与组装。[https://chartreuse-room-39e.notion.site/dd8c976117b243ab879e304d015bf4ac](/dd8c976117b243ab879e304d015bf4ac)
...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/003-89ce6995.png)
...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/004-09e8fa85.png)
...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/005-25395e70.png)


![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/006-ff247c1b.png)


当我们把数据设置进Instance Buffer的Custom data里面之后，我们在材质里面就可以取到啦。


![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/007-b5c6fc11.png)
...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/008-dcbc1b4c.png)
...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/009-04fb1b54.png)


但是，这里的InstanceLocalPosition得到的顶点并不直接是我们要的R旋转应用之后的顶点位置，因为我们将S缩放矩阵存储在Scale上，所以我们还得 除于 Scale缩放值，我们才能拿到正确的值。


![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/010-8d92f453.png)
...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/011-11cf63a3.png)
...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/012-83518d97.png)


![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/013-4ab80d07.png)


根据 伴随转置矩阵计算器，便可以计算得出M的伴随转置矩阵


[一步步解的计算器 - Symbolab](https://zs.symbolab.com/solver/matrix-adjoint-calculator/%5Cadj%5Cbegin%7Bpmatrix%7Da%260%260%5C%5C%20%20%20%200%26b%260%5C%5C%20%20%20%200%260%26c%5Cend%7Bpmatrix%7D)


![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/014-a5d15309.png)
...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/015-84a2ea0f.png)
