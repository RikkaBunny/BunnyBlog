...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/001-e3649824.png)
...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/002-729773cc.png)
...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/003-515d61b3.png)
...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/004-cb110cc5.png)
...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/005-6c5ee5ee.png)


![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/006-1667af34.png)


当我们把数据设置进Instance Buffer的Custom data里面之后，我们在材质里面就可以取到啦。


![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/007-74a758e6.png)
...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/008-3133baa1.png)
...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/009-70418d45.png)


但是，这里的InstanceLocalPosition得到的顶点并不直接是我们要的R旋转应用之后的顶点位置，因为我们将S缩放矩阵存储在Scale上，所以我们还得 除于 Scale缩放值，我们才能拿到正确的值。


![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/010-13736923.png)
...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/011-a6b43da8.png)
...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/012-95d2ba3a.png)


![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/013-b49a366a.png)
...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/014-f93ea4f2.png)
...
![Untitled.png](assets/houdini中岩石任意形变矩阵到ue还原/015-5b0e6d48.png)
