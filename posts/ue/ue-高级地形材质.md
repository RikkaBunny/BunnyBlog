...
source: "notion-sync"
---
![Untitled.png](assets/ue-高级地形材质/001-36477fd4.png)
...
![Untitled.png](assets/ue-高级地形材质/002-3a26199a.png)
...
![Untitled.png](assets/ue-高级地形材质/003-72d3087e.png)


下面就是贴图在引擎里面的设置啦，我们可以右键所有贴图Asset Actions → Bulk Editvia Property Matrix  使用批处理来修改贴图设置。


![Untitled.png](assets/ue-高级地形材质/004-512923ef.png)


我们需要把C_R开头的贴图sRGB勾上，N_S_H开头的sRGB去掉。然后所有压缩格式用BC7 ，Mipmap设置为 Sharpen10  锐化度为10(可以自行调整)，这样能让我们在远处也有比较清晰的贴图。


为什么用BC7压缩了？（BC7与 Direct X 11 一起发布，是一种更高级的 S3 压缩格式，它使用一系列方法对 4 个纹理数据通道进行编码。与**DXT1/5（BC1/3）**等旧格式相比，它将提供更高质量的压缩和更少的伪像，并支持 sRGB，但它永远会保留 Alpha 通道。）
...
![Untitled.png](assets/ue-高级地形材质/005-476f6906.png)


![Untitled.png](assets/ue-高级地形材质/006-6abb9257.png)


![Untitled.png](assets/ue-高级地形材质/007-fca431c5.png)
...
![Untitled.png](assets/ue-高级地形材质/008-28d0978d.png)


Virtual Height field Mesh Material


![Untitled.png](assets/ue-高级地形材质/009-e0d97d16.png)
...
![Untitled.png](assets/ue-高级地形材质/010-851aad95.png)
...
![Untitled.png](assets/ue-高级地形材质/011-be850805.png)
...
![Untitled.png](assets/ue-高级地形材质/012-3ee014cb.png)


最前面是UV，我们把UVSacle暴露出去。


![Untitled.png](assets/ue-高级地形材质/013-1b2d0d2d.png)


先看UseCellBomb为false的状态，C_R这里很简单就是将RGB给一个Color Tint 之后直接输入到BaseColor既可，A通道直接给Rougness就可以啦。


![Untitled.png](assets/ue-高级地形材质/014-8479364f.png)
...
![Untitled.png](assets/ue-高级地形材质/015-b7a83e2c.png)
...
![Untitled.png](assets/ue-高级地形材质/016-898d2b26.png)


对于解析法线 ，我们通常需要将法线从 0 到 1 空间转换到 -1 到 1的空间，然后叉乘计算出Z，我们可以顺带法线增强也一起写了，对于法线增强其实就是增强X 和 Y两个轴，最后将结果归一化基本就可以啦。


![Untitled.png](assets/ue-高级地形材质/017-7ad6e99c.png)


但是后面发现法线出现不规则黑斑，经过测试发现着部分法线的长度等于任何值，所以我在后面加上了一个法线错误检查，如果法线出现错误，那么输出法线 (0,0,1)。


![Untitled.png](assets/ue-高级地形材质/018-7ba9a552.png)


![Untitled.png](assets/ue-高级地形材质/019-cfede270.png)


![Untitled.png](assets/ue-高级地形材质/020-5716bdfb.png)


![Untitled.png](assets/ue-高级地形材质/021-177ccf25.png)
...
![Untitled.png](assets/ue-高级地形材质/022-b66a04f4.png)


![Untitled.png](assets/ue-高级地形材质/023-b2bfac09.png)
...
![Untitled.png](assets/ue-高级地形材质/024-d4c2f5e1.png)


这里每一块都代表一块UV的缩放、平移、旋转。


![Untitled.png](assets/ue-高级地形材质/025-2ec32486.png)
...
![Untitled.png](assets/ue-高级地形材质/026-8c47803b.png)
...
![Untitled.png](assets/ue-高级地形材质/027-bc075d14.png)


![Untitled.png](assets/ue-高级地形材质/028-a6d6bdd8.png)


当你屏幕上大部分是远景时候，能提供大物体之间的自阴影


![Untitled.png](assets/ue-高级地形材质/029-cb3ab526.png)


![Untitled.png](assets/ue-高级地形材质/030-079d9e80.png)


开启方法：


![Untitled.png](assets/ue-高级地形材质/031-3e6b7b51.png)


![Untitled.png](assets/ue-高级地形材质/032-702b7477.png)
...
![Untitled.png](assets/ue-高级地形材质/033-223ab5d0.png)


![Untitled.png](assets/ue-高级地形材质/034-b9b70ae7.png)
