...
![Untitled.png](assets/unreal中搭建houdini自动化流程/001-10e3e90e.png)
...
![Untitled.png](assets/unreal中搭建houdini自动化流程/002-b808be4a.png)
...
![Untitled.png](assets/unreal中搭建houdini自动化流程/003-4d850a17.png)
...
![Untitled.png](assets/unreal中搭建houdini自动化流程/004-76a27739.png)


![Untitled.png](assets/unreal中搭建houdini自动化流程/005-70f97b86.png)
...
![Untitled.png](assets/unreal中搭建houdini自动化流程/006-b9e8b0cb.png)
...
![Untitled.png](assets/unreal中搭建houdini自动化流程/007-5f939f4f.png)


有了回调之后，我们就可以在`OnPreInstantiationDelegate`回调的时候`设置参数拉。`


![Untitled.png](assets/unreal中搭建houdini自动化流程/008-3d81998e.png)
...
![Untitled.png](assets/unreal中搭建houdini自动化流程/009-125655d7.png)


创建一个空的输入类。


![Untitled.png](assets/unreal中搭建houdini自动化流程/010-26c3ba98.png)


![Untitled.png](assets/unreal中搭建houdini自动化流程/011-a5a86de7.png)
...
![Untitled.png](assets/unreal中搭建houdini自动化流程/012-2bc1f082.png)


如果我们还需要Bake出来的结果。那么我们还要在设置一下Bake相关。当cook完之后，回调函数就会自动调用Bake。Bake相关设置也对应HDA面板上的设置。


![Untitled.png](assets/unreal中搭建houdini自动化流程/013-c7738888.png)


![Untitled.png](assets/unreal中搭建houdini自动化流程/014-048f161a.png)
...
![Untitled.png](assets/unreal中搭建houdini自动化流程/015-92aafc43.png)
