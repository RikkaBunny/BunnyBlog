...
source: "notion-sync"
---
![Untitled.png](assets/watermaterial/001-e4b092fb.png)


这是我们通常得到水面到水底深度的公式，最终得到的结果是一个从0到1的渐变Mask，           


![Untitled.png](assets/watermaterial/002-39804330.png)
...
![Untitled.png](assets/watermaterial/003-ffa8297c.png)


这一步也可以使用LUT的方式来采样颜色，已到达更好控制的效果。我们可以去PS里面做一张LUT的色彩控制表，


![Untitled.png](assets/watermaterial/004-372392bd.png)


最终我们导出的LUT表，我用的是256*1像素，那么我们uv的U就是我们从0到1的深度渐变值，V就可以定值，主要LUT不要压缩，tiling为clamp，不然就会采样到错误位置。


![Untitled.png](assets/watermaterial/005-53cfb291.png)


![Untitled.png](assets/watermaterial/006-6e75aeff.png)
...
![Untitled.png](assets/watermaterial/007-7e8b8fa0.png)


之后有个稍微特殊的地方，就可以可能特别近的岸边和特别远的远景，透明度还得单独处理一下，这里我让特别近的岸边水更加透明，显的水比较清澈，很远处的水不透明，显的更深邃一点。


![Untitled.png](assets/watermaterial/008-045afdad.png)


最后还加上 菲涅尔 和 顶点色对透明度影响输出既可。


![Untitled.png](assets/watermaterial/009-93484cf7.png)
...
![Untitled.png](assets/watermaterial/010-ed04ca3b.png)
...
![Untitled.png](assets/watermaterial/011-32ad8dca.png)


还有一个便是与flowmap 产生的法线做 混合，用的RNM方法具体如下。


![Untitled.png](assets/watermaterial/012-920443f2.png)
...
![water.gif](assets/watermaterial/013-fbf3f6b6.gif)


大体是这样


![Untitled.png](assets/watermaterial/014-0d279a92.png)


顶点色R是控制混合区域，顶点色B是流速控制波浪的大小，流速缓慢的地方波浪小，湍急的地方波浪大。


![Untitled.png](assets/watermaterial/015-b856bf16.png)


波形状就是这段


![Untitled.png](assets/watermaterial/016-2661ba0c.png)
...
![Untitled.png](assets/watermaterial/017-44e59367.png)


这样就能达到焦散在水底的感觉啦


![waterCaustics.gif](assets/watermaterial/018-1eba40c7.gif)
...
![Untitled.png](assets/watermaterial/019-d26ff4c3.png)


![Untitled.png](assets/watermaterial/020-d6b85ca1.png)
...
![Untitled.png](assets/watermaterial/021-f9cbd86b.png)


![Untitled.png](assets/watermaterial/022-9bf7e74b.png)


FlowmapSimple 里面逻辑也很简单，主要就两张贴图循环交替的移动，造就视觉上的一个移动假象，波形大概是这样，交替迭代，然后动态lerp两张图片的结果既可。


![Untitled.png](assets/watermaterial/023-4c603614.png)
...
![Untitled.png](assets/watermaterial/024-f87eb641.png)
