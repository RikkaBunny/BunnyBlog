...
source: "notion-sync"
---
![Untitled.png](assets/watermaterial/001-b96c9f47.png)


这是我们通常得到水面到水底深度的公式，最终得到的结果是一个从0到1的渐变Mask，           


![Untitled.png](assets/watermaterial/002-239bda3b.png)
...
![Untitled.png](assets/watermaterial/003-ce382702.png)


这一步也可以使用LUT的方式来采样颜色，已到达更好控制的效果。我们可以去PS里面做一张LUT的色彩控制表，


![Untitled.png](assets/watermaterial/004-cfe68e9f.png)


最终我们导出的LUT表，我用的是256*1像素，那么我们uv的U就是我们从0到1的深度渐变值，V就可以定值，主要LUT不要压缩，tiling为clamp，不然就会采样到错误位置。


![Untitled.png](assets/watermaterial/005-ca6b0f36.png)


![Untitled.png](assets/watermaterial/006-a87b3271.png)
...
![Untitled.png](assets/watermaterial/007-f9b23550.png)


之后有个稍微特殊的地方，就可以可能特别近的岸边和特别远的远景，透明度还得单独处理一下，这里我让特别近的岸边水更加透明，显的水比较清澈，很远处的水不透明，显的更深邃一点。


![Untitled.png](assets/watermaterial/008-cfece6a3.png)


最后还加上 菲涅尔 和 顶点色对透明度影响输出既可。


![Untitled.png](assets/watermaterial/009-212646e8.png)
...
![Untitled.png](assets/watermaterial/010-17246a85.png)
...
![Untitled.png](assets/watermaterial/011-17fbad18.png)


还有一个便是与flowmap 产生的法线做 混合，用的RNM方法具体如下。


![Untitled.png](assets/watermaterial/012-92abe10c.png)
...
![water.gif](assets/watermaterial/013-f877a4f8.gif)


大体是这样


![Untitled.png](assets/watermaterial/014-1d04161d.png)


顶点色R是控制混合区域，顶点色B是流速控制波浪的大小，流速缓慢的地方波浪小，湍急的地方波浪大。


![Untitled.png](assets/watermaterial/015-65dfabb1.png)


波形状就是这段


![Untitled.png](assets/watermaterial/016-02e39d0c.png)
...
![Untitled.png](assets/watermaterial/017-1f817c54.png)


这样就能达到焦散在水底的感觉啦


![waterCaustics.gif](assets/watermaterial/018-ab363f4f.gif)
...
![Untitled.png](assets/watermaterial/019-b7796fa1.png)


![Untitled.png](assets/watermaterial/020-dfb6b74c.png)
...
![Untitled.png](assets/watermaterial/021-10702248.png)


![Untitled.png](assets/watermaterial/022-f593d297.png)


FlowmapSimple 里面逻辑也很简单，主要就两张贴图循环交替的移动，造就视觉上的一个移动假象，波形大概是这样，交替迭代，然后动态lerp两张图片的结果既可。


![Untitled.png](assets/watermaterial/023-73ceece8.png)
...
![Untitled.png](assets/watermaterial/024-597e4344.png)
