...
source: "notion-sync"
---
![Untitled.png](assets/watermaterial/001-c5016c24.png)


这是我们通常得到水面到水底深度的公式，最终得到的结果是一个从0到1的渐变Mask，           


![Untitled.png](assets/watermaterial/002-ca7bf1a8.png)
...
![Untitled.png](assets/watermaterial/003-b213b03e.png)


这一步也可以使用LUT的方式来采样颜色，已到达更好控制的效果。我们可以去PS里面做一张LUT的色彩控制表，


![Untitled.png](assets/watermaterial/004-2a97f2c8.png)


最终我们导出的LUT表，我用的是256*1像素，那么我们uv的U就是我们从0到1的深度渐变值，V就可以定值，主要LUT不要压缩，tiling为clamp，不然就会采样到错误位置。


![Untitled.png](assets/watermaterial/005-19d6cbf8.png)


![Untitled.png](assets/watermaterial/006-b918efc1.png)
...
![Untitled.png](assets/watermaterial/007-779b7bed.png)


之后有个稍微特殊的地方，就可以可能特别近的岸边和特别远的远景，透明度还得单独处理一下，这里我让特别近的岸边水更加透明，显的水比较清澈，很远处的水不透明，显的更深邃一点。


![Untitled.png](assets/watermaterial/008-6d0a9c7c.png)


最后还加上 菲涅尔 和 顶点色对透明度影响输出既可。


![Untitled.png](assets/watermaterial/009-c855526d.png)
...
![Untitled.png](assets/watermaterial/010-a1cbc301.png)
...
![Untitled.png](assets/watermaterial/011-0ac84712.png)


还有一个便是与flowmap 产生的法线做 混合，用的RNM方法具体如下。


![Untitled.png](assets/watermaterial/012-f43830cc.png)
...
![water.gif](assets/watermaterial/013-311cb4b1.gif)


大体是这样


![Untitled.png](assets/watermaterial/014-3ef65d0b.png)


顶点色R是控制混合区域，顶点色B是流速控制波浪的大小，流速缓慢的地方波浪小，湍急的地方波浪大。


![Untitled.png](assets/watermaterial/015-d5d6bb4c.png)


波形状就是这段


![Untitled.png](assets/watermaterial/016-becea050.png)
...
![Untitled.png](assets/watermaterial/017-b2d1b476.png)


这样就能达到焦散在水底的感觉啦


![waterCaustics.gif](assets/watermaterial/018-4df12898.gif)
...
![Untitled.png](assets/watermaterial/019-306b58e2.png)


![Untitled.png](assets/watermaterial/020-ede52d37.png)
...
![Untitled.png](assets/watermaterial/021-9dc2f785.png)


![Untitled.png](assets/watermaterial/022-ed78beb5.png)


FlowmapSimple 里面逻辑也很简单，主要就两张贴图循环交替的移动，造就视觉上的一个移动假象，波形大概是这样，交替迭代，然后动态lerp两张图片的结果既可。


![Untitled.png](assets/watermaterial/023-27e2b3c6.png)
...
![Untitled.png](assets/watermaterial/024-18b28f67.png)
