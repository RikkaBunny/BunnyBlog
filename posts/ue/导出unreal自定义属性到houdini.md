...
![Untitled.png](assets/导出unreal自定义属性到houdini/001-8e44a99f.png)


可以看到有两个GetSpline，其实两个返回结果都一样，只不过一个是对象，一个方法。我们可以双击进入代码实现看见。


![Untitled.png](assets/导出unreal自定义属性到houdini/002-b2dd1b44.png)
...
![Untitled.png](assets/导出unreal自定义属性到houdini/003-9a444d06.png)
...
![Untitled.png](assets/导出unreal自定义属性到houdini/004-51cb8f53.png)


![Untitled.png](assets/导出unreal自定义属性到houdini/005-b4c04501.png)


这样我们就可以得到河流的自定义属性，通过蓝图遍历我们选择的物体就可以得到我们需要的数据，这里我们需要保存我们需要的数据到CSV中，我们可以自己创建一个public的蓝图函数库类，自己封装一个保存Function。


![Untitled.png](assets/导出unreal自定义属性到houdini/006-5e1907b1.png)


![Untitled.png](assets/导出unreal自定义属性到houdini/007-16d62339.png)


![Untitled.png](assets/导出unreal自定义属性到houdini/008-dc5b631a.png)
