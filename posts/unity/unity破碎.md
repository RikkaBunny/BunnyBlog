X-Amz-SignedHeaders=host&x-amz-checksum-mode=ENABLED&x-id=GetObject)
...
![Untitled.png](assets/unity破碎/002-cc1ff5fb.png)


Voronoi Fracture


![Untitled.png](assets/unity破碎/003-1a688148.png)


自己切


![Untitled.png](assets/unity破碎/004-beae4145.png)
...
![Untitled.png](assets/unity破碎/005-85148731.png)
...
![Untitled.png](assets/unity破碎/006-86d83abd.png)


然后我们就可以Foreach 循环遍历我们的每一块，再切一次，基本就可以得到我们最终的结果(也需要删除内部UV)


![Untitled.png](assets/unity破碎/007-9b126c3c.png)
...
![Untitled.png](assets/unity破碎/008-6ebbb4dc.png)


![Untitled.png](assets/unity破碎/009-8ca066a8.png)
...
![Untitled.png](assets/unity破碎/010-c4288e67.png)


首先我们将钢筋分为一段一段的pack起来，这样一段钢筋其实就是一个点云，我们就可以使用xyzdist找到离我们一定范围内的钢筋段，再将钢筋段扭曲一下模拟一下损坏的感觉既可


![Untitled.png](assets/unity破碎/011-b5969794.png)
...
![Untitled.png](assets/unity破碎/012-bd3700a3.png)
...
![Untitled.png](assets/unity破碎/013-cad5b769.png)
...
![Untitled.png](assets/unity破碎/014-3c1e7a5e.png)


然后使用RBDCluster将相邻的块给组合起来，就可以得到边缘比较棱角分明的形状


![Untitled.png](assets/unity破碎/015-e8144cf7.png)


在将多余的点线面给剔除掉


![Untitled.png](assets/unity破碎/016-77d46a26.png)
...
![Untitled.png](assets/unity破碎/017-a825b1a7.png)


![Untitled.png](assets/unity破碎/018-af5af658.png)


![Untitled.png](assets/unity破碎/019-f79a3270.png)
...
![Untitled.png](assets/unity破碎/020-09f3c94d.png)
...
![Untitled.png](assets/unity破碎/023-f7acfabf.png)


想要得到一个破损的法线，我们可以直接用labs的EdgeDamage节点做模型的边缘磨损效果(也可自己写)。


![Untitled.png](assets/unity破碎/024-6782159e.png)
...
![Untitled.png](assets/unity破碎/025-1831ee51.png)


![Untitled.png](assets/unity破碎/026-abfc4300.png)
...
![Untitled.png](assets/unity破碎/027-38629904.png)


![Untitled.png](assets/unity破碎/028-cb7542b2.png)


边缘磨损这边就是通过SDF 得到两个Mask，叠加两层磨损效果既可，这个就看个人发挥，这里木头给了一个拉丝的噪声既可。


![Untitled.png](assets/unity破碎/029-c3e0d8f3.png)


![Untitled.png](assets/unity破碎/030-d6454221.png)


![Untitled.png](assets/unity破碎/031-248f1e78.png)


玻璃材质这里有几个小的注意点，透明需要根据 Fresnel 来，越正面越透明，越边缘越不透明， 折射也是需要根据Fresnel来lerp。这两点有了 那么玻璃的大体感觉也会出来了，


![Untitled.png](assets/unity破碎/032-4a8fc544.png)
...
![Untitled.png](assets/unity破碎/033-6820343e.png)
