X-Amz-SignedHeaders=host&x-amz-checksum-mode=ENABLED&x-id=GetObject)
...
![Untitled.png](assets/unity破碎/002-cbce085f.png)


Voronoi Fracture


![Untitled.png](assets/unity破碎/003-7fbd82ad.png)


自己切


![Untitled.png](assets/unity破碎/004-f630e5e1.png)
...
![Untitled.png](assets/unity破碎/005-e370ddd3.png)
...
![Untitled.png](assets/unity破碎/006-7218945e.png)


然后我们就可以Foreach 循环遍历我们的每一块，再切一次，基本就可以得到我们最终的结果(也需要删除内部UV)


![Untitled.png](assets/unity破碎/007-52a8b04d.png)
...
![Untitled.png](assets/unity破碎/008-4f058537.png)


![Untitled.png](assets/unity破碎/009-e270afe5.png)
...
![Untitled.png](assets/unity破碎/010-ef25915e.png)


首先我们将钢筋分为一段一段的pack起来，这样一段钢筋其实就是一个点云，我们就可以使用xyzdist找到离我们一定范围内的钢筋段，再将钢筋段扭曲一下模拟一下损坏的感觉既可


![Untitled.png](assets/unity破碎/011-9cd5ee5a.png)
...
![Untitled.png](assets/unity破碎/012-b080b95e.png)
...
![Untitled.png](assets/unity破碎/013-4c932bf1.png)
...
![Untitled.png](assets/unity破碎/014-278ee091.png)


然后使用RBDCluster将相邻的块给组合起来，就可以得到边缘比较棱角分明的形状


![Untitled.png](assets/unity破碎/015-f9ebbdcd.png)


在将多余的点线面给剔除掉


![Untitled.png](assets/unity破碎/016-d6fd9ac0.png)
...
![Untitled.png](assets/unity破碎/017-08cb65de.png)


![Untitled.png](assets/unity破碎/018-811121dc.png)


![Untitled.png](assets/unity破碎/019-c3748f71.png)
...
![Untitled.png](assets/unity破碎/020-e82894be.png)
...
![Untitled.png](assets/unity破碎/023-b4b1170a.png)


想要得到一个破损的法线，我们可以直接用labs的EdgeDamage节点做模型的边缘磨损效果(也可自己写)。


![Untitled.png](assets/unity破碎/024-69aec397.png)
...
![Untitled.png](assets/unity破碎/025-5e8da0a9.png)


![Untitled.png](assets/unity破碎/026-02303148.png)
...
![Untitled.png](assets/unity破碎/027-4ed232a2.png)


![Untitled.png](assets/unity破碎/028-e7769495.png)


边缘磨损这边就是通过SDF 得到两个Mask，叠加两层磨损效果既可，这个就看个人发挥，这里木头给了一个拉丝的噪声既可。


![Untitled.png](assets/unity破碎/029-f0828f5b.png)


![Untitled.png](assets/unity破碎/030-601a6115.png)


![Untitled.png](assets/unity破碎/031-d5ead2e7.png)


玻璃材质这里有几个小的注意点，透明需要根据 Fresnel 来，越正面越透明，越边缘越不透明， 折射也是需要根据Fresnel来lerp。这两点有了 那么玻璃的大体感觉也会出来了，


![Untitled.png](assets/unity破碎/032-18951c3f.png)
...
![Untitled.png](assets/unity破碎/033-f25cd4f4.png)
